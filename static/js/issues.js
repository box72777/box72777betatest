...
function addToVerify(length) {
  ...
  for (var index = 0; index < length; index++) {
    ...
    var dataJSON = {};
    dataJSON.email = email.innerText;
    dataJSON.uuid = uuid.innerText;
...
function addVrerifyTable(obj) {
  ...
  for (var index = 0; index < obj.length; index++) {
    ...
    // Uuid
    var newCell_task_uuid = newRow.insertCell();
    var newText_task_uuid = document.createTextNode(obj[index].uuid);
    newCell_task_uuid.id = "uuid_" + index;
    newCell_task_uuid.style = "display:none;";
    newCell_task_uuid.appendChild(newText_task_uuid);
  }
}
...
function addVerifiedTable(list_uuid) {
  ...
  for (var index = 0; index < list_uuid.length; index++) {
    ...
    newCell_username.className = "text-center";
    newCell_username.appendChild(newText_username);

    // token
    var newCell_email = newRow.insertCell();
    var newText_email = document.createTextNode(obj.token);
    newCell_email.className = "text-center";
    ...
    newCell_token.className = "text-center";
    newCell_token.appendChild(newText_token);
  }
}
